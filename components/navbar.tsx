      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://www.youtube.com/@IvyLeagueSprouts" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-red-600 transition-colors" aria-label="YouTube">
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-bright-purple-200">
              ...
              <a href="https://www.youtube.com/@IvyLeagueSprouts" target="_blank" rel="noopener noreferrer" className="block px-3 py-2 text-gray-700 hover:text-red-600 font-medium" aria-label="YouTube">
                <div className="flex items-center gap-2"><Youtube className="h-5 w-5" /> YouTube</div>
              </a>
